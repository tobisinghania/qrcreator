...
class Version {
    ...
    final int[] alignmentPatternCenters
    final int totalCodewords
    ...
    private Version(int versionNumber, int[] alignmentPatternCenters, ECBlocks... ecBlocks) {
        ...
        totalCodewords = ecBlocks[0].ECBlocks.sum { ECB ecBlock -> ecBlock.count * (ecBlock.dataCodewords + ecCodewords) } as int
    }
     ...
     * @throws IllegalFormatException if dimension is not 1 mod 4
     */
    static Version getProvisionalVersionForDimension(int dimension) throws IllegalFormatException {
        if (dimension % 4 != 1) {
    ...
    static Version decodeVersionInformation(int versionBits) {
        ...
        int bestVersion = 0
        int size = VERSION_DECODE_INFO.size()
    ...
    static class ECBlocks {
        ...
        int getNumBlocks() {
            ECBlocks.sum { ECB ecBlock -> ecBlock.count } as int
        }
    ...
    private static Version[] buildVersions() {
        return [
            ...
            new Version(14, [6, 26, 46, 66] as int[],
            ...
            new Version(15, [6, 26, 48, 70] as int[],
            ...
            new Version(16, [6, 26, 50, 74] as int[],
            ...
            new Version(17, [6, 30, 54, 78] as int[],
            ...
            new Version(18, [6, 30, 56, 82] as int[],
            ...
            new Version(19, [6, 30, 58, 86] as int[],
            ...
            new Version(20, [6, 34, 62, 90] as int[],
            ...
            new Version(21, [6, 28, 50, 72, 94] as int[],
            ...
            new Version(24, [6, 28, 54, 80, 106] as int[],
            ...
            new Version(25, [6, 32, 58, 84, 110] as int[],
            ...
            new Version(26, [6, 30, 58, 86, 114] as int[],
            ...
            new Version(27, [6, 34, 62, 90, 118] as int[],
            ...
            new Version(28, [6, 26, 50, 74, 98, 122] as int[],
            ...
            new Version(29, [6, 30, 54, 78, 102, 126] as int[],
            ...
            new Version(30, [6, 26, 52, 78, 104, 130] as int[],
            ...
            new Version(31, [6, 30, 56, 82, 108, 134] as int[],
            ...
            new Version(32, [6, 34, 60, 86, 112, 138] as int[],
            ...
            new Version(33, [6, 30, 58, 86, 114, 142] as int[],
            ...
            new Version(34, [6, 34, 62, 90, 118, 146] as int[],
            ...
            new Version(35, [6, 30, 54, 78, 102, 126, 150] as int[],
            ...
            new Version(36, [6, 24, 50, 76, 102, 128, 154] as int[],
            ...
            new Version(37, [6, 28, 54, 80, 106, 132, 158] as int[],
            ...
            new Version(38, [6, 32, 58, 84, 110, 136, 162] as int[],
            ...
            new Version(39, [6, 26, 54, 82, 110, 138, 166] as int[],
            ...
            new Version(40, [6, 30, 58, 86, 114, 142, 170] as int[],
                    ...
                    new ECBlocks(30, new ECB(20, 15), new ECB(61, 16)))] as Version[]
    }
}
